...
export default function TitleBar() {
  ...
  return (
    <div className="h-titlebar bg-vsc-titlebar grid grid-cols-[1fr_auto_1fr] items-center min-w-0 overflow-hidden no-select text-vsc-sm border-b border-vsc-panel-border/25"
      ...
      {/* Right — Layout toggles + window controls + status */}
      <div className="flex items-center justify-end gap-0.5 pr-1 flex-shrink-0 flex-nowrap justify-self-end min-w-0" style={{ WebkitAppRegion: 'no-drag' }}>
